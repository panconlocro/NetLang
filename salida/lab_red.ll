...
@str.Switch2 = private unnamed_addr constant [8 x i8] c"Switch2\00", align 1
...
@str.Server1 = private unnamed_addr constant [8 x i8] c"Server1\00", align 1
...
@str.iface.Router1.eth1 = private unnamed_addr constant [5 x i8] c"eth1\00", align 1
@str.ip.Router1.eth1 = private unnamed_addr constant [9 x i8] c"10.0.0.1\00", align 1
@str.mask.Router1.eth1 = private unnamed_addr constant [14 x i8] c"255.255.255.0\00", align 1
...
@str.ip.PC2.eth0 = private unnamed_addr constant [13 x i8] c"192.168.1.20\00", align 1
@str.mask.PC2.eth0 = private unnamed_addr constant [14 x i8] c"255.255.255.0\00", align 1
@str.iface.Server1.eth0 = private unnamed_addr constant [5 x i8] c"eth0\00", align 1
@str.ip.Server1.eth0 = private unnamed_addr constant [10 x i8] c"10.0.0.10\00", align 1
@str.mask.Server1.eth0 = private unnamed_addr constant [14 x i8] c"255.255.255.0\00", align 1
...
@str.iface.Switch1.port3 = private unnamed_addr constant [6 x i8] c"port3\00", align 1
@str.iface.Switch2.port1 = private unnamed_addr constant [6 x i8] c"port1\00", align 1
@str.iface.Switch2.port2 = private unnamed_addr constant [6 x i8] c"port2\00", align 1
...
@device.2 = global %device_t { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.Switch2, i32 0, i32 0), i32 1 }
@device.3 = global %device_t { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.PC1, i32 0, i32 0), i32 2 }
@device.4 = global %device_t { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.PC2, i32 0, i32 0), i32 2 }
@device.5 = global %device_t { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.Server1, i32 0, i32 0), i32 2 }
@device_count = global i32 6
...
@interface.1 = global %interface_t { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.Router1, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.iface.Router1.eth1, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @str.ip.Router1.eth1, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.mask.Router1.eth1, i32 0, i32 0) }
@interface.2 = global %interface_t { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.PC1, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.iface.PC1.eth0, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @str.ip.PC1.eth0, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.mask.PC1.eth0, i32 0, i32 0) }
@interface.3 = global %interface_t { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.PC2, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.iface.PC2.eth0, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @str.ip.PC2.eth0, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.mask.PC2.eth0, i32 0, i32 0) }
@interface.4 = global %interface_t { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.Server1, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.iface.Server1.eth0, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @str.ip.Server1.eth0, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @str.mask.Server1.eth0, i32 0, i32 0) }
@interface_count = global i32 5
...
@connect.2 = global %connect_t { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.PC2, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.iface.PC2.eth0, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.Switch1, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.iface.Switch1.port3, i32 0, i32 0), i32 100000, i32 2000 }
@connect.3 = global %connect_t { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.Router1, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.iface.Router1.eth1, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.Switch2, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.iface.Switch2.port1, i32 0, i32 0), i32 1000000, i32 1000 }
@connect.4 = global %connect_t { i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.Server1, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @str.iface.Server1.eth0, i32 0, i32 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.Switch2, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.iface.Switch2.port2, i32 0, i32 0), i32 100000, i32 5000 }
@connect_count = global i32 5

; ── Punto de entrada ─────────────────────────────────────────
define i32 @main() {
entry:
  ; Red: LabRed — 6 dispositivo(s), 2 subred(es),
  ;                  5 interfaz(ces), 5 conexion(es)
  ret i32 0
}
...
public class NetLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"NETWORK", "DEVICE", "SUBNET", "INTERFACE", "CONNECT", "TO", "IP", "MASK", 
			"GATEWAY", "BANDWIDTH", "LATENCY", "ROUTER", "SWITCH", "HOST", "KBPS", 
			"MBPS", "GBPS", "MS", "US", "LBRACE", "RBRACE", "DOT", "SLASH", "ID", 
			"INT", "WS", "COMMENT"
		};
	}
	...
	public NetLangLexer(CharStream input) {
		super(input);
